...
Reminder: for the rest of the queries, the focus will be on the the payment data that falls under the participating column also within the 
continental United States (including Hawaii)
